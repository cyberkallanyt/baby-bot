...
+ 'FN:cyberkallan\n' // Nama
+ 'ORG:Baby bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=7510457855:+91 751-045-7855\n' // Nomor bot
+ 'END:VCARD' 
...
Ketik ${prefix}verify to start using bot.`
  ...
  only: {
    ...
    ownerG: '*☒* This feature is only for *OWNER GRUP*',
    ownerB: '*☒* This feature is for *OWNER BOT*',
    admin: '*☒* This feature is for *ADMIN GRUP*',
    Badmin: '*☒* Make it Babybot *ADMIN !*',
    daftarB: `Hai, Type *${prefix}verify* to start using the bot`
  }
}
...
‣ Type: *ON*
‣ Group:  *${groupName}*
‣ amount user : *${_registered.length} User*
‣ amount chat : *${totalchat.length} Chat*
‣ Github : https://github.com/cyberkallanyt/baby-bot
‣ Official group
• _${Wa1}_
...
┃ _Info about bot_
┠⊷️ *${prefix}Owner*
┃ _Info owner of the Bot_
┠⊷️ *${prefix}gpay*
┃ _Info about donation_
┠⊷️ *${prefix}Ping*
...
┃ _Shows admin list_
┠⊷️ *${prefix}Listonline*
┃ _Shows a list of online members_
┠⊷️ *${prefix}Closegc*
┃ _Closing Group_
┠⊷️ *${prefix}Opengc*
┃ _Open Groups_
...
┃ _Ex : ${prefix}Chatprank hai arjun/ok_
┠⊷️ *${prefix}Itsme*
┃ _Showing profile_
┠⊷️ *${prefix}Fml*
...
┃ _Shows vn bot list_
┠⊷️ *${prefix}listimg*
┃ _Shows a list of photos_
┠⊷️ *${prefix}liststik*
┃ _Shows a list of bot stickers_
┠⊷️ *${prefix}listvid*
┃ _Shows video list_
...
┠⊷ *${prefix}is (Text)*
┠⊷ *${prefix}Can (Text)*
┠⊷ *${prefix}WhenWillyou (Text)*
┠⊷ *${prefix}Rate (Text)*
┠⊷ *${prefix}Handsome (Text)*
┠⊷ *${prefix}Prettycheck (Text)*
┗━━━━━━━━━━━━━━━━━━━━
*〘 TOOLS 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Stiker*
┃ _Create stickers from images / videos_
┠⊷️ *${prefix}Triggered*
┃ _Create triggered stickers_
┠⊷️ *${prefix}Wasted*
┃ _ Make wasted stickers_
┠⊷️ *${prefix}Ttp (Text)*
┃ _Create stickers from text_
┠⊷️ *${prefix}Toimg*
┃ _Convert stickers into images_
┠⊷️ *${prefix}Tomp3*
...
┃ _Random boys photo_
┠⊷️ *${prefix}girls*
┃ _Random photo girls_
┠⊷️ *${prefix}Meme*
┃ _Random meme_
┠⊷️ *${prefix}Twit*
┃ _Random foto status Twitter_
┠⊷️ *${prefix}Quotes*
┃ _Random photo quotes_
┠⊷️ *${prefix}Wp*
┃ _Random wallpaper_
┠⊷️ *${prefix}Cyberpunk*
┃ _Random photo cyberpunk_
┠⊷️ *${prefix}Img (Query)*
...
┃ _Translate all languages_
┠⊷️ *${prefix}Fakta*
┃ _Ramdom facts_
┠⊷️ *${prefix}Languagecode*
┃ _Shows language code_
┠⊷️ *${prefix}Countrycode*
┃ _Shows country code_
┗━━━━━━━━━━━━━━━━━━━━
*〘 OTHER 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Lirik (nee hima mayayas)*
┃ Search for song lyrics
┠⊷️ *${prefix}Chord (veel muruga*)
...
┠⊷️ *${prefix}Beritahoax*
┃ _Shows fake news info_
┠⊷️ *${prefix}Gplaystore*
┃ _Search for applications in the plstr_
┗━━━━━━━━━━━━━━━━━━━━
*〘 HOROSCOPE 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Arti (Name)*
┃ _Find out the meaning of your name_
...
*〘 ISLAM 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Alquran (Number surah)*
┃ _ Displays surah in the Al-Qur'an_
┠⊷️ *${prefix}Ngaji*
┃ _Random verse in surah Al-Qur'an_
...
//---Zodiak harian
case 'zodiak':
if (args.length < 1) return reply('*☒* Input The Zodiac Name')
Lxa.updatePresence(from, Presence.composing)
if (!isRegister) return reply(mess.only.daftarB)
teks = body.slice(8)
try {
...
case 'boys':
  ...
  Lxa.updatePresence(from, Presence.composing)
  uk = ["kannapi boy","cool guy","handsome man","chunni mownuse","chullan myr"]
  nk = uk[Math.floor(Math.random() * uk.length)]
  try {
  data = await fetchJson(`https://api.fdci.se/sosmed/rep.php?gambar=${nk}`, {
method: 'get'
...
case 'seberapagay':
  ...
  if (args.length < 1) return Lxa.sendMessage(from, '*☒* Enter a question', text, {
quoted: mek
  })
  teks = body.slice(13)
  Lxa.updatePresence(from, Presence.composing)
...
case 'seberapabucin':
  ...
  if (args.length < 1) return Lxa.sendMessage(from, '*☒* Enter the target name', text, {
quoted: mek
  })
  teks = body.slice(15)
  try {
...
case 'name':
  if (args.length < 1) return reply('*☒* Enter a name')
Lxa.updatePresence(from, Presence.composing)
if (!isRegister) return reply(mess.only.daftarB)
...
case 'kusonime':
  ...
  if (args.length < 1) return reply('*☒* Enter the name of the anime')
  try {
...
if (args.length < 1) return reply('*☒* Input username')
try {
...
case 'when':
  ...
  hasil = `Whenwillyou : *${body.slice(10)}*\n\nAnswer : *${random2} ${random}*`
  reply(hasil)
  break
...
case 'When':
  ...
  random = kapankah[Math.floor(Math.random() * (kapankah.length))]
  random2 = `${Math.floor(Math.random() * 8)}`
  hasil = `Whenwillyou : *${body.slice(7)}*\n\nAnswer : *${random2} ${random}*`
  reply(hasil)
  break
...
if (!isRegister) return reply(mess.only.daftarB)
const tagme = {
  text: `@${sender.split("@")[0]} Hai mownuse`,
  contextInfo: {
mentionedJid: [sender]
  }
}
...
//---Buy limit
/*case 'buylimit':
  if (args.length < 1) return reply(`What is the limit you want to buy? Make sure the ATM balance is sufficient too! \n\n How to check balance : ${prefix}Ceksaldo`)
  if (!isRegister) return reply(mess.only.daftarB)
...
await reply(`〘  *MEMORANDUM PAYMENT*  〙\n\n‣ *Sender* : Admin\n‣ *Receiver* : ${pushname}\n‣ *Purchase nominal* : ${body.slice(10)} \n‣ *Limit price* : ${koinPerlimit}/limit\n‣ *The remaining balance* : ${checkATMuser(sender)}\n\n Successful process with payment number \n${createSerial(15)}`)
  }
  break
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`❌ Failed, at the time of converting ${tipe} stiker`)
							})
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata('Baby-bot', 'Cyberkallan')} ${ran} -o ${ran}`, async (error) => {
...
//-- temp
			...
			case 'addstik':
				...
				svst = body.slice(9)
				if (!svst) return reply('Name The sticker ')
			...
			case 'addvn':
				...
				if (!isOwner) return reply(mess.only.ownerB)
				svst = body.slice(7)
				if (!svst) return reply('Name the  audio')
				boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
				delb = await Lxa.downloadMediaMessage(boij)
				audionye.push(`${svst}`)
...
case 'addme':
  case 'register':
if (isRegister) return reply('Your account has been verified')
...
tm = `verification complete please type ${prefix}Menu to display the menu list,treply(tm)
break
...
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
open = {
  text: `Group opened by admin @ $ {sender.split ("@") [0]} \ n now *all participants * can send messages`,
  contextInfo: {
mentionedJid: [sender]
  }
}
...
break
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('')
					} else if (Number(args[0]) === 0) {Successfully activated the welcome feature in this group
